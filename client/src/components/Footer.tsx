    ...
    return (
        <footer>
            ...
            <div className="w-[95%] 800px:w-full 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8">
                ...
                <div className="space-y-3">
                    <h3 className="text-[20px] font-[600] text-black dark:text-white">Follow Us</h3>
                    <ul className="space-y-4">
                        <li>
                            <Link href={"/"} className="text-base text-black dark:text-gray-300 dark:hover:text-white">Facebook</Link>
                        </li>
                        <li>
                            <Link href={"/"} className="text-base text-black dark:text-gray-300 dark:hover:text-white">Twitter</Link>
                        </li>
                        <li>
                            <Link href={"/"} className="text-base text-black dark:text-gray-300 dark:hover:text-white">Instagram</Link>
                        </li>
                    </ul>
                </div>
                <div className="">
            ...
            <p className="text-center text-black dark:text-white">
                Copyright &copy; 2025 BuyLMS | All Rights Reserved
            </p>
            </div>
            <br />
        </footer>
