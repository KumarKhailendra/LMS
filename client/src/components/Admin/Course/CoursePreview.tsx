...
const CoursePreview:React.FC<Props> = ({
  ...
  useEffect(() => {
    const fetchResolution = async () => {
      try {
        const result = await videoResolution(courseData?.demoUrl);
    ...
    <div className='w-[90%] m-auto py-5 mb-5'>
      <div className="w-full relative">
        <div className="w-full mt-10">
          <VideoPlayer src={`${basePath}videos/video/${courseData?.demoUrl}/${quality}`} qualityOptions={resolution} setQuality={setQuality} />
        </div>
